...
\begin{frame}{А так ли страшен чёрт?}
        ...
        \begin{itemize}
                ...
                \item<5-> Ваша сеть получает подписанные маршруты?
                        ...
                        \end{itemize}
                \item<7-> Ваши сервисы проверяют сертификат соединения? % при обращении наружу, журнал этого есть?
                \item<8-> \textbf{Однако, современные взломы чаще основаны на бардаке}
        \end{itemize}
\end{frame}
...
\begin{frame}{Защита от прослушки DNS}
        ...
        \begin{itemize}
                \item<1->DNSCrypt
        \end{itemize}
        \onslide<2-> Защишенный транспорт
        \begin{itemize}
...
\begin{frame}{Шифрование канала}
        ...
        \begin{itemize}
                ...
                \item Защита обмена между потребителем и ресолвером
        \end{itemize}
\end{frame}
