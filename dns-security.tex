...
\begin{frame}{Основные проблемы. Прослушка}
        \begin{itemize}
                ...
                {\small \textcolor{blue}{\href{https://en.wikipedia.org/wiki/DNS\_hijacking\#Manipulation\_by\_ISPs}{https://en.wikipedia.org/wiki/DNS\_hijacking\#Manipulation\_by\_ISPs}}}
...
\begin{frame}{DNSSEC. Настройка клиентов} % выбор в зависимости от доверия и цели
        \begin{itemize}
...
\begin{frame}{DNSSEC. Must have}
        \begin{itemize}
                ...
                \begin{itemize}
                        \item<1-> CoreDNS имеет отличную реализацию DNSSEC
                \end{itemize}
