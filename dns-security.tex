...
\begin{frame}[t]{Как устроен DNS}%
        \includegraphics[height=0.9\textheight]{pic1.png}
\end{frame}
...
\begin{frame}{Угорозы в системе DNS}
        \includegraphics[height=0.8\textheight]{pic2.png}
\end{frame}
...
\begin{frame}{Основные проблемы}
        \begin{itemize}
                ...
                \begin{itemize}
                        ...
                        \item<1-> Атака на Route53 в апреле 2018 года % https://www.internetsociety.org/blog/2018/04/amazons-route-53-bgp-hijack/
                \end{itemize}
                \item<2-> Прослушка
                \begin{itemize}
                        ...
                        \item<2-> RFC7626 -- 73.1\% могут быть узнаны по слепку DNS
...
\begin{frame}{Реакционизм. Прослушка}
        \centering\includegraphics[height=0.8\textheight]{pic6.png}<1>
        \begin{itemize}
...
\begin{frame}{Многое осталось за кадром}
        \begin{itemize}
                ...
                \item Обслуживание и эксплуатация DNS, DNSSEC, DoT/DoH
